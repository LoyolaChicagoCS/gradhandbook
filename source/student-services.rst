...
Students should discuss roles and expectations with their advisor or prospective advisors.
...
If a student's sole advisor resigns their CS appointment, leaves Loyola, retires or becomes emeritus, that faculty member can serve as the student's sole academic advisor for up to one year after leaving the CS Department or University.
After one year, the faculty member can continue to serve as a research advisor, but the student must also obtain a current CS faculty member as their academic advisor.

Students are also allowed to have more than one advisor.
Advisor roles can be equal or set up as primary and secondary.
A student may have more than one current CS advisor, but at least one is required.
As long as a student has one current CS faculty member as an academic advisor, any additional advisor(s) can be from outside of the CS Department, faculty from a department without a graduate program, academic staff, emeritus faculty, advising faculty, faculty from another institution, scientists, research associates, or other individuals deemed qualified by the CS Graduate Committee.
The academic advisor is expected to meet with the student periodically, advise the student on CS policies and requirements including milestone timing, and remain familiar with the student's research.

The academic advisor is responsible for annual reporting on the student's progress and serves as chair of the preliminary and final oral examination committees.
In recognition of this relationship, the student is expected to enroll in at least one credit of CS 490/595 with the academic advisor each semester.
**Incoming PhD students are expected to establish a relationship with a research advisor by the end of the first year of graduate study.**

Research advisors are specifically responsible for monitoring and advising students on their research.
Research credits are taken in the research advisor's course section number.
...
International Student and Scholar Services (ISSS), part of Loyola's Office of Global and Community Engagement, helps international students navigate the immigration requirements associated with studying in the United States.
Following admission, ISSS assists with Form I-20 and DS-2019 issuance and advises F-1 and J-1 students on maintaining lawful status, enrollment and reporting requirements, reduced course loads, program extensions, SEVIS transfers, changes of education level, travel signatures, and re-entry.
Most applications and document requests are submitted through the ISSS Portal.
The office also provides guidance on on-campus employment, Curricular Practical Training (CPT), Optional Practical Training (OPT), STEM OPT, J-1 Academic Training, and Social Security documentation through its student-employment resources.

ISSS also supports international scholars, faculty, staff, and Loyola departments seeking to hire or sponsor foreign nationals.
Its team conducts pre-hire visa reviews and assists with H-1B employment, J-1 interns and exchange visitors, university-sponsored permanent residency, and required Department of Labor notifications.
Beyond immigration compliance, ISSS offers individual advising, employment workshops, immigration-policy and travel updates, and programs and events that connect Loyola's international community across its campuses and throughout Chicago.
These services combine regulatory guidance with community engagement to support international students and scholars from their initial arrival through graduation or completion of their Loyola appointment.

Key ISSS Personnel
====================

.. list-table:: Key ISSS Personnel (as of August 14, 2026)
   :header-rows: 1
   :widths: 15 30 35 20
   ...
   * - Person
     ...
     - Contact
   * - Amy Soub
     - Director; Principal Designated School Official and Responsible Officer (PDSO/RO)
     - Office leadership and immigration-program oversight
     - `asoub@luc.edu <mailto:asoub@luc.edu>`_
   * - Abby Mensing
     - Assistant Director; Designated School Official and Alternate Responsible Officer (DSO/ARO)
     - International scholars, sponsored employees, and hiring units
     - `amensing@luc.edu <mailto:amensing@luc.edu>`_
   * - Zhen Ju
     - Senior International Student Advisor; DSO/ARO
     - Student advising for surnames A-L
     - `zju@luc.edu <mailto:zju@luc.edu>`_
   * - Scott Jones
     - International Student Advisor; DSO/ARO
     - Student advising for surnames M-Z
     - `sjones8@luc.edu <mailto:sjones8@luc.edu>`_

.. list-table:: Key ISSS Websites and Services
   :header-rows: 1
   :widths: 30 70
   ...
   * - Website or Service
     - URL
   * - ISSS homepage
     - `<https://www.luc.edu/isss/>`_
   * - ISSS Portal
     - `<https://isss.luc.edu/>`_
   * - Appointments and contact information
     - `<https://www.luc.edu/isss/aboutus/appointmentscontactinfo/>`_
   * - F-1 and J-1 student resources
     - `<https://www.luc.edu/isss/f-1j-1students/>`_
   * - Prospective international students
     - `<https://www.luc.edu/isss/prospective.shtml>`_
   * - Current F-1 students
     - `<https://www.luc.edu/isss/currentinternationalstudents.shtml>`_
   * - J-1 exchange students
     - `<https://www.luc.edu/isss/f-1j-1students/j-1exchangestudents/>`_
   * - Student employment
     - `<https://www.luc.edu/isss/f-1j-1students/studentemployment/>`_
   * - International faculty and staff
     - `<https://www.luc.edu/isss/facultystaff.shtml>`_
   * - Immigration policy updates
     - `<https://www.luc.edu/isss/immigrationandtravelresources/immigrationpolicyupdatesresources/>`_
   * - International travel
     - `<https://www.luc.edu/isss/immigrationandtravelresources/internationaltravel/>`_
